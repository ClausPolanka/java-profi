 ...
 */
public final class ProducerMultiConsumerSizedExample3
{
    public static void main(String[] args)
    {
        final int MAX_QUEUE_SIZE = 7;
        final FixedSizeContainer<Item> items = new BlockingFixedSizeBuffer<Item>(MAX_QUEUE_SIZE);
    ...
    private ProducerMultiConsumerSizedExample3()
    {        
    }
}
