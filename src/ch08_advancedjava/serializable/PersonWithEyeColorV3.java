 ...
 */
public final class PersonWithEyeColorV3 implements Serializable
{
    private String          name;
    ...
    public PersonWithEyeColorV3(final String name, final String city, final Date birthday, final Color eyeColor)
    {
        this.name = name;
        this.city = city;
    ...
    public boolean equals(final Object other)
    {
        ...
        final PersonWithEyeColorV3 otherPerson = (PersonWithEyeColorV3) other;
        return equalsImpl(otherPerson);
    }

    private boolean equalsImpl(final PersonWithEyeColorV3 otherPerson)
    {
