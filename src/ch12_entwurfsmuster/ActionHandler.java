...
/**
 * Die Klasse ActionHandler ist ein Teil des Beispielprogramms für das Prototyp-Muster:
 ...
 * in der Klasse AppFrame zur Verknüpfung und Behandlung verschiedener Toolbar-Buttons 
 * dient. Mit deren Hilfe können neue Figuren erzeugt werden. Des Weiteren erlauben die
...
class ActionHandler
{
    ...
    public void handlePasteElement()
    {
        if (clipboardElement != null)
        {
            ...
            // hier nochmal kopieren, damit wir mehrfach pasten können
