...
/**
 * Testklasse für die Klasse StringToListUtils2, basierend auf JUnit 4
 * 
 * @author Michael Inden
 * 
 * Copyright 2011 by Michael Inden 
 */
public final class StringToListUtils2Test
{
    ...
    public void testNormalLineEnding()
    {
        ...
        final List<String> result = StringToListUtils2.convertByteArrayToStringList(input);
